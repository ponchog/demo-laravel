		...
		<div class="breadcrumb-container">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li class="active">Carlos Torres</li>
				</ol>
			</div>
		</div>
		<!-- breadcrumb end -->
				...
				<div class="tab-pane in active" id="h2tab1">
					<div class="row" style="padding:20px;">				
						...
						<div class="row grid-space-20">
							<div class="col-xs-3">
								<div class="overlay-container">
									<img src="/images/artists/carlos/tatto serigrafia 50x35cm.jpg" alt="">
									<a href="/images/artists/carlos/tatto serigrafia 50x35cm.jpg" class="overlay-link small popup-img" title="Second image title">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="overlay-container">
									<img src="/images/artists/carlos/Formalidades 10x12_ acrilic.jpeg" alt="">
									<a href="/images/artists/carlos/Formalidades 10x12_ acrilic.jpeg" class="overlay-link small popup-img" title="Third image title">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="overlay-container">
									<img src="/images/artists/carlos/Pachuco  linograbado paper 26x27_..jpg" alt="">
									<a href="/images/artists/carlos/Pachuco  linograbado paper 26x27_..jpg" class="overlay-link small popup-img" title="Fourth image title">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
							<div class="col-xs-3">
								<div class="overlay-container">
									<img src="/images/artists/carlos/Pachuco 57x59_ oil on canvas.jpg" alt="">
									<a href="/images/artists/carlos/Pachuco 57x59_ oil on canvas.jpg" class="overlay-link small popup-img" title="Fifth image title">
										<i class="fa fa-plus"></i>
									</a>
								</div>
							</div>
					...
					<div class="row grid-space-20">
						<div class="col-xs-3">
							<div class="overlay-container">
								<img src="/images/artists/carlos/Roberto    pin and coshion 16x15x7_.jpg" alt="">
								<a href="/images/artists/carlos/Roberto    pin and coshion 16x15x7_.jpg" class="overlay-link small popup-img" title="Fifth image title">
									<i class="fa fa-plus"></i>
								</a>
							</div>
						</div>
