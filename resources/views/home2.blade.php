				...
				<ul class="slides">
					...
					<div class="tp-caption tp-fade fadeout fullscreenvideo"
						...
						<video class="" preload="none" width="100%" height="100%" poster='videos/video-banner-poster.jpg'> 
							<source id="vid1" src="videos/home_1.mp4" type='video/mp4'></source>
					...
					<div class="tp-caption sfb fadeout small_white"
						...
						data-easing="easeOutQuad"
						data-endspeed="600">
						<a href="#" class="btn btn-dark btn-animated" style="padding-right:0px;">View More </a>
							{{-- <i class="fa fa-arrow-right"></i> --}}						
						{{-- <a href="page-contact.html" class="btn btn-default btn-animated">Contact Us 
