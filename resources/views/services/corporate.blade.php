...
<div class="banner dark-translucent-bg" style="background-image:url('/images/pattern-4.png'); background-position: 50% 30%;">
		...
		<div class="breadcrumb-container">
			<div class="container">
				<ol class="breadcrumb">
					...
					<li><a class="link-dark" href="">Services</a></li>
					<li class="active">For Corporate Buyers</li>
				</ol>
			</div>
		</div>
		<!-- breadcrumb end -->
	<div class="container">
		<div class="row">
			<div class="col-md-8 text-center col-md-offset-2 pv-20">
				...
				<p class="text-center">Arte International provides Corporate Buyers access to exceptional and contemporary Latino artworks from the various Latin American artists that we can provide you the Corporate Buyer an array of options and choices to help you achieve your goal.</p>
			</div>
		</div>
	</div>
</div>
